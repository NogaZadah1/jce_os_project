...
M5_SRC = file_reader.c traveler.c ipc.c parent_controller.c m5_gui_adapter.c node_sync.c
M6_SRC = file_reader.c traveler.c ipc.c parent_controller.c m5_gui_adapter.c node_sync.c
